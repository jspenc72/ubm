...
$grid->addColumn('account_id', 'Acct #', 'string');  
 ...
 * 
 */
$result = $mysqli->query("SELECT * FROM ubm_model_projected_financial_statement_income_statement_credits WHERE model_UUID=$activeModelUUID ORDER BY account_id LIMIT 100");
$mysqli->close();
