 ...
 * 
 */
$result = $mysqli->query("SELECT * FROM ubm_model_projected_financial_statement_balance_sheet_credits WHERE model_UUID=$activeModelUUID ORDER BY account_id LIMIT 100");
$mysqli->close();
