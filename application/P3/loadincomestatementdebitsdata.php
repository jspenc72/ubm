...
*/
$grid->addColumn('id', 'Line #', 'integer', NULL, false); 				//adding NULL, false makes the table Cell uneditable to the user.
$grid->addColumn('account_id', 'Acct #', 'string', NULL, false);  
...
$grid->addColumn('account_total', 'Total', 'html', NULL, false);  
 ...
 * 
 */
$result = $mysqli->query("SELECT * FROM ubm_model_projected_financial_statement_income_statement_debits WHERE model_UUID=$activeModelUUID ORDER BY account_id LIMIT 100");
$mysqli->close();
