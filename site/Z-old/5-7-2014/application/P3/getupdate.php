...
$colname = $mysqli->real_escape_string(strip_tags($_GET['colname']));
$id = $mysqli->real_escape_string(strip_tags($_GET['id']));
$coltype = $mysqli->real_escape_string(strip_tags($_GET['coltype']));
$value = $mysqli->real_escape_string(strip_tags($_GET['newvalue']));
$tablename = $mysqli->real_escape_string(strip_tags($_GET['tablename']));                                    
