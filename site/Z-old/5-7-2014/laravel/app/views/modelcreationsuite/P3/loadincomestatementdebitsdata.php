...
$grid->addColumn('account_number', 'Acct #', 'string', NULL, false);  
 ...
 * 
 */
$result = $mysqli->query('SELECT * FROM ubm_model_projected_financial_statement_income_statement_debits WHERE model_id="1" ORDER BY account_id LIMIT 100');
$mysqli->close();
