													...
													//ID of the page containing the list     demo-page
													//ID of the Unordered List               sortedList
													//ID of the linkbar		                 sorter
...
$.mobile.document.on( "pageshow", "#demo-page", function() {
	...
	$( "#sorter li" ).click( function() {
		var top,
			letter = $( this ).text(),
			divider = $( "#sortedList" ).find( "li.ui-li-divider:contains(" + letter + ")" ); //Id of the sorted listview is given here
