...
if ($rs === false) {
    ...
    while ($items = $rs->fetch_assoc()) {
        ...
        $activeModelId = $returnedModelId;
         //Obtain the id for the appropriate category
...
for ($x = 1; $x <= $num_rows; $x++) {
    ...
    $sqlsel2 = "SELECT * FROM model_creation_suite_has_final_reviewed_by_records WHERE model_id='$activeModelUUID' AND task_id='$x'";
     //Select all
    ...
    $sqlsel3 = "SELECT * FROM model_creation_suite_has_reviewed_by_records WHERE model_id='$activeModelUUID' AND task_id='$x'";
     //Select all
    ...
    $sqlsel4 = "SELECT * FROM model_creation_suite_has_prepared_by_records WHERE model_UUID='$activeModelUUID' AND task_id='$x'";
     //Select all
    ...
    $sqlsel5 = "SELECT * FROM model_creation_suite WHERE line_number='$x'";
     //Select all
