...
$sqlins = "INSERT INTO ubm_model_has_procedures (model_id, procedure_id) VALUES ($v2, $v6)";

if ($conn -> query($sqlins) === false) {
	trigger_error('Wrong SQL: ' . $sqlins . ' Error: ' . $conn -> error, E_USER_ERROR);
} else {
	$sqlins2 = "INSERT INTO ubm_model_policy_has_procedures (policy_id, procedure_id) VALUES ($v5, $v6)";
