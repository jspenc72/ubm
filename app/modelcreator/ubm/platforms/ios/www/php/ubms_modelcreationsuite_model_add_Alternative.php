...
$sqlins = "INSERT INTO ubm_model_alternatives (model_UUID, description, decision, created_by) VALUES ( $v2, $v3, $v4, $v5 )"; //Creates a New Core Value record.
if ($conn -> query($sqlins) === false) {
	...
	if ($conn -> query($sqlins2) === false) {
		...
		echo $_GET['callback'] . '(' . "{'message' : 'Requested Alternative $alternativeDescription was created successfully and added to model UUID: $activeModelUUID !'}" . ')';
	}
}
