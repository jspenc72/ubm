...
$sqlins = "INSERT INTO ubm_model_has_policies (model_id, policy_id) VALUES ($v2, $v5)";

if ($conn -> query($sqlins) === false) {
	trigger_error('Wrong SQL: ' . $sqlins . ' Error: ' . $conn -> error, E_USER_ERROR);
} else {
	$sqlins2 = "INSERT INTO ubm_model_jobdescription_has_policies (jobdescription_id, policy_id) VALUES ($v4, $v5)";
