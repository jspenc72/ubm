...
$sqlins = "INSERT INTO ubm_model_has_steps (model_id, step_id) VALUES ($v2, $v7)";

if ($conn -> query($sqlins) === false) {
	trigger_error('Wrong SQL: ' . $sqlins . ' Error: ' . $conn -> error, E_USER_ERROR);
} else {
	$sqlins2 = "INSERT INTO ubm_model_procedure_has_steps (procedure_id, step_id) VALUES ($v6, $v7)";
