...
$sqlins = "INSERT INTO ubm_model_alternatives (model_id, description, decision, created_by) VALUES ( $v2, $v3, $v4, $v5 )"; //Creates a New Core Value record.
if ($conn -> query($sqlins) === false) {
	trigger_error('Wrong SQL: ' . $sqlins . ' Error: ' . $conn -> error, E_USER_ERROR);
} else {
	$last_inserted_id = $conn -> insert_id;
	//$affected_rows = $conn -> affected_rows;
	$sqlins2 = "INSERT INTO ubm_model_has_alternatives (model_id, alternative_id) VALUES ( $v2, $last_inserted_id )";
