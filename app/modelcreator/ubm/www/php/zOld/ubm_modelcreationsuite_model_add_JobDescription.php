...
$sqlins = "INSERT INTO ubm_model_has_jobDescriptions (model_id, jobdescription_id) VALUES ( $v2, $v4 )";

if ($conn -> query($sqlins) === false) {
	trigger_error('Wrong SQL: ' . $sqlins . ' Error: ' . $conn -> error, E_USER_ERROR);
} else {
	$sqlins2 = "INSERT INTO ubm_model_position_has_jobDescriptions (position_id, jobdescription_id) VALUES ( $v4, $v3 )";
