...
$v3 = "'" . $conn -> real_escape_string($activeStrategicPositioningId) . "'";
 ...
 $sql="DELETE FROM ubm_model_has_strategicpositioning_questions WHERE strategicpositioning_question=$activeStrategicPositioningId AND model_id=$activeModelId";
