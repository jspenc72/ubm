...
$title = $_GET['requestedApplicationTitle'];
...
$sqlins = "INSERT INTO ubm_model_requestedapplications (title) VALUES ( $v2, )"; //Creates a New Core Value record.
if ($conn -> query($sqlins) === false) {
	trigger_error('Wrong SQL: ' . $sqlins . ' Error: ' . $conn -> error, E_USER_ERROR);
} else {
	$last_inserted_id = $conn -> insert_id;
	//$affected_rows = $conn -> affected_rows;
	$sqlins2 = "INSERT INTO ubm_model_has_requestedapplications (model_id, requestedapplication_id) VALUES ( $v5, $last_inserted_id )";
...
echo $_GET['callback'] . '(' . "{'message' : 'Requested Application $title created successfully!'}" . ')';
