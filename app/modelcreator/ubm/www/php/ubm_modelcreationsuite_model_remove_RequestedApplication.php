...
$v3 = "'" . $conn -> real_escape_string($activeRequestedApplicationId) . "'";

 $sql="DELETE FROM ubm_model_has_requestedapplications WHERE requestedapplication_id=$activeRequestedApplicationId AND model_id=$activeModelId";
