...
if ($rs1 === false) {
    ...
    $all_items[0]['num_models_created'] = mysqli_num_rows($rs1);
}
...
if ($rs2 === false) {
    ...
    $all_items[0]['num_shared_models'] = mysqli_num_rows($rs2);
}
...
if ($rs3 === false) {
    ...
    $all_items[0]['num_created_model_hierarchical_objects'] = $numCreatedPositions + $numCreatedJobDescriptions + $numCreatedPolicies + $numCreatedProcedures + $numCreatedSteps + $numCreatedTasks;
    $all_items[0]['num_created_positions'] = $numCreatedPositions;
    $all_items[0]['num_created_jobdescriptions'] = $numCreatedJobDescriptions;
    $all_items[0]['num_created_policies'] = $numCreatedPolicies;
    $all_items[0]['num_created_procedures'] = $numCreatedProcedures;
    $all_items[0]['num_created_steps'] = $numCreatedSteps;
    $all_items[0]['num_created_tasks'] = $numCreatedTasks;
}
