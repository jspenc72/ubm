...
$pdf->SetHeaderData(false, 0, PDF_HEADER_TITLE.' - 045', PDF_HEADER_STRING);
//$pdf->SetHeaderData("Header logo jpg, width of header logo, pdf Header title, pdf header string.");
