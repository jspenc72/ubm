...
$sqlins = "INSERT INTO ubm_model_has_positions (model_id, position_id, model_position_reports_to_id) VALUES ($v2, $v3, $v4)";
echo $v2, $v3, $v4;
...
echo $_GET['callback'] . '(' . "{'message' : 'The number of affected rows is $affected_rows. the position $activePositionId reports to $positionReportsTo.'}" . ')';
