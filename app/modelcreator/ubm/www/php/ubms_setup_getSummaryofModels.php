...
echo "</br><center>Application Title: <strong>BMCL Model Creator Application / API V1.0.4 Alpha</strong></center>";
echo "</br><center>Summary of Users and their Models</center>";
