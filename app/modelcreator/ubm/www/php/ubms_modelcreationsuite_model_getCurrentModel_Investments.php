...
$sqlsel1 = "SELECT * FROM ubm_model_has_alternatives WHERE model_UUID=$activeModelUUID";
...
if ($rs1 === false) {
    ...
    if (mysqli_num_rows($rs1) > 1) {
        while ($items1 = $rs1->fetch_assoc()) {
            ...
            $sqlsel2 = "SELECT * FROM ubm_model_alternatives WHERE id=$returnItemId AND decision='Use Now'";
            ...
            if ($rs2 === false) {
                ...
                while ($items2 = $rs2->fetch_assoc()) {
                    ...
                    $sqlsel3 = "SELECT * FROM ubm_model_alternative_has_investments WHERE alternative_id=$returnItemId2";
                    ...
                    if ($rs2 === false) {
                        ...
                        while ($items3 = $rs3->fetch_assoc()) {
                            ...
                            $sqlsel4 = "SELECT * FROM ubm_model_investments WHERE id=$returnItemId3";
        ...
        $all_items[] = array("title" => 'No Investments');
        echo $_GET['callback'] . '(' . json_encode($all_items) . ')';
    }
}
