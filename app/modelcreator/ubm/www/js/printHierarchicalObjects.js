...
function printModel() {
    var link = "http://api.universalbusinessmodel.com/tcpdf/app/examples/all_ubm_hierarchicalObjects.php?callback=?&activeModelOwnersUUID=" + window.activeModelOwnersUUID + "";
    window.open(link, '_blank');
}