...
$(document).ready(function() {
    validate();
    $('.reviewedBy_actionRequired_input').change(validate);
});

function validateSetActiveTaskIncomplete() {
    if ($('.reviewedBy_actionRequired_input').val().length > 0 {
            $(".setActiveTaskIncomplete").prop("disabled", false);
        } else {
            $(".setActiveTaskIncomplete").prop("disabled", true);
        }
    }
