...
{ 
	this.editableGrid = new EditableGrid("projected_financial_statement_balance_sheet_debits", {
		enableSort: true,
...
{ 
	this.editableGrid = new EditableGrid("projected_financial_statement_balance_sheet_credits", {
		enableSort: true,
...
{ 
	this.editableGrid = new EditableGrid("projected_financial_statement_income_statement_debits", {
		enableSort: true,
...
{ 
	this.editableGrid = new EditableGrid("projected_financial_statement_income_statement_credits", {
		enableSort: true,
